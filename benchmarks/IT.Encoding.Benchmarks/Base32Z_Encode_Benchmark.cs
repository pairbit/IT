...
public class Base32Z_Encode_Benchmark
{
    private ITextEncoder _base32 = new Base32Encoder_deniszykov_Wiry(true);
    private ITextEncoder _base32_deniszykov = new Base32Encoder_deniszykov(true);
    private ITextEncoder _base32_Wiry = new Base32Encoder_Wiry(true);
    internal byte[] _data;
    ...
    public String deniszykov_Bench() => deniszykov.BaseN.ZBase32Convert.ToString(_data);

    [Benchmark(Description = "deniszykov2")]
    public String deniszykov2_Bench() => deniszykov.BaseN.BaseNEncoding.ZBase32.GetString(_data);

    [Benchmark(Description = "IT_Wiry")]
    public String IT_Wiry_Bench() => _base32_Wiry.EncodeToText(_data);

    [Benchmark(Description = "Wiry")]
    public String Wiry_Bench() => Wiry.Base32.Base32Encoding.ZBase32.GetString(_data);

    [Benchmark(Description = "SimpleBase")]
    public String SimpleBase_Bench() => SimpleBase.Base32.ZBase32.Encode(_data);

    [Benchmark(Description = "MikValSor")]
    public String MikValSor_Bench() => MikValSor.Encoding.Base32Encoder.Encode(_data, MikValSor.Encoding.Base32Format.ZBase32, false);

    //[Benchmark(Description = "Multiformats")]
    public String Multiformats_Bench() => Multiformats.Base.Multibase.EncodeRaw(Multiformats.Base.MultibaseEncoding.Base32Z, _data);
